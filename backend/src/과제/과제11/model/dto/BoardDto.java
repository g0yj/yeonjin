...
public class BoardDto {
	...
	//1. 필드: db table 필드명과 순서 일치화 권장
	private int bno;
	private String btitle;
	private String bcontent;
	private String bdate;
	private int bview;
	private int mno;	// 작성자가 회원번호 식별자라면..?!
		// 화면에는 작성자를 회원번호가 아닌 회원 다른 정보 출력
	
	private String mid; // 회원번호를 이용한 회원테이블 조회가 가능![JOIN]
		// 회원번호가 아닌 아이디를 받고 싶다고해도 sql에는 추가하지 않아야함.
		// DTO는 휘발성 데이터로 여기서 만들어주면됨.
